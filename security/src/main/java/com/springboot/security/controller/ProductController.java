...
public class ProductController {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "X-AUTH-TOKEN", value = "로그인 성공후 발급 받은 access_token", required = true, dataType = "String", paramType = "header")})
    @PostMapping()
    ...
    @PutMapping()
    public ResponseEntity<ProductResponseDto> changeProdutName(@RequestBody ChangeProductNameDto changeProductNameDto) throws Exception {
